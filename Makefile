...
abs_srcdir=	/Users/dcallahan/projects/Python/Python-3.5.2
abs_builddir=	/Users/dcallahan/projects/Python/Python-3.5.2
...
OPCODE_H_GEN=	python3.5  $(OPCODE_H_SCRIPT) $(srcdir)/Lib/opcode.py $(OPCODE_H)
#
##########################################################################
# AST
AST_H_DIR=	Include
...
ASDLGEN=	python3.5 $(srcdir)/Parser/asdl_c.py
